...
internal static class SymbolRenamer
{
    ...
    public static async Task<Project> PerformRenamesAsync(Project project, IEnumerable<(ISymbol Original, string NewName)> symbolsWithNewNames, IProgress<ConversionProgress> progress)
    {
