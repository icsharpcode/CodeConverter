...
export default class NavMenu extends React.PureComponent<{}, { isOpen: boolean }> {
    ...
    public render() {
        return (
            <header>
                <Navbar className="navbar-expand-sm border-bottom box-shadow mb-3" dark>
                    <Container>
                        <NavbarBrand tag={Link} to="/">ICSharp<span className="title-highlight">Code Converter</span></NavbarBrand>
                        ...
                        <a href="https://github.com/icsharpcode/CodeConverter" target="_blank" rel="noopener noreferrer" className="github-corner" aria-label="View source on Github">
                            <svg width="80" height="80" viewBox="-30 0 250 250" className="octo-svg" aria-hidden="true">
