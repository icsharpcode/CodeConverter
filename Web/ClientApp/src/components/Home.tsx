        ...
        <div className="col-md-8">
            <div id="app">
                <div className="form-group">
                    ...
                    <textarea id="inputTextArea" v-model="inputCode" className="form-control" rows={10} style={{
                        minWidth: "100%"
                    }}></textarea>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    <textarea id="outputTextArea" v-model="convertedCode" className="form-control" rows={10} style={{
                        minWidth: "100%"
                    }}></textarea>
                </div>

                {props.ShowErrors &&
                    <p style={{ whiteSpace: "pre-wrap" }}>Error message:<br/>{props.ErrorMessageOnResponse}</p>}
