...
namespace CSharpToVBCodeConverter.Util
{
    public static class SyntaxTriviaExtensions
    {
        ...
        public static bool MatchesKind(this SyntaxTrivia trivia, params VB.SyntaxKind[] kinds)
        {
            foreach (VB.SyntaxKind kind in kinds)
            {
        ...
        /// <returns></returns>
        public static SyntaxToken RemoveDirectiveTrivia(this SyntaxToken Token, ref bool FoundEOL)
        {
            var NewLeadingTrivia = new List<SyntaxTrivia>();
            var NewTrailingTrivia = new List<SyntaxTrivia>();
        ...
        public static SyntaxTriviaList ToSyntaxTriviaList(this List<SyntaxTrivia> l)
        {
            var NewSyntaxTriviaList = new SyntaxTriviaList();
            return NewSyntaxTriviaList.AddRange(l);
        }
